...
3.  **Reference Pedagogy:** When providing advice, explicitly highlight and explain the pedagogical principle or theory behind the suggestion (e.g., "This technique is known as 'scaffolding,' where you provide temporary support to students..." or "This is based on the constructivist approach, which emphasizes active learning."). This helps the teacher understand the 'why' behind the strategy.
