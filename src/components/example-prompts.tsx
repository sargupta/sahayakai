...
const promptTranslations: Record<string, Record<string, string>> = {
  ...
  hibiscusDiagram: {
    ...
    te: "4వ తరగతి కోసం మందార భాగాల యొక్క సాధారణ రేఖా����ిత్రాన్ని గీయండి",
  ...
  braveMouse: {
    ...
    te: "2వ తరగతికి చెందిన ధైర్యమైన ఎలుక గురిం�����న ఒక చిన్న కథ",
  ...
  visualAidFlower: {
    ...
    bn: "একটি ফুলের একটি সাধারণ অঙ্কন যা তার প্রধান অংশগুলি দেখায়: মূল, কাণ্ড, পাতা এ��ং ��াপড়ি।",
    ...
    kn: "ಹೂವಿನ ಒಂದು ಸರಳ ರೇಖಾಚಿತ್ರವು ಅದರ ಮುಖ್ಯ ಭಾಗಗಳನ್ನು ತೋರಿಸುತ್ತದೆ: ಬ��ರು, ���ಾಂಡ, ಎಲೆ ಮತ್ತು ದಳ.",
  },
  visualAidWaterCycle: {
    ...
    ta: "ஆவியாதல், ஒடுக்கம் மற்றும் மழைப்பொழிவுக்���ான லேபிள்களுடன் நீர் சுழற்சியைக் காட்டும் ஒரு வரைபடம்.",
  ...
  visualAidHeart: {
    ...
    te: "నాలుగు గదులతో మానవ గుండె యొ���్క సాధా���ణ రేఖాచిత్రం.",
  ...
  worksheetFillInBlanks: {
    ...
    mr: "या पृष्ठ��वरून, इयत्ता 2 साठी 5 रिकाम्या जागा भरा प्रश्न तयार करा.",
  ...
  worksheetMatchFollowing: {
    ...
    hi: "इस पृष्ठ से जानवरों के नाम और उनकी आवाज़ का उपयोग करके कक्षा 1 के लिए 'निम्नलिखित का ��िलान करें' गतिविधि बनाएं।",
    ...
    ta: "இந்தப் பக்கத்திலிருந்து விலங்குகளின் பெயர்கள் மற்று���் அவற்றின் ஒலிகளைப் பயன்படுத்தி 1 ஆம் வகுப்பிற்கு 'பின்வருவனவற்றைப் பொருத்து' என்ற செயல்பாட்டை உருவாக்கவும்.",
  ...
  worksheetWordSearch: {
    ...
    hi: "कक्षा 3 ���े लिए, इस पृ���्ठ पर कठिन शब्दों के साथ एक शब्द खोज पहेली बनाएं।",
    ...
    gu: "ધોરણ 3 માટે, આ પૃષ્ઠ પરના મુ���્કેل શબ્દો સાથે એક શબ્દ શોધ પઝલ બનાવો.",
  ...
  imageLessonPlan: {
    ...
    ta: "இந்த பாடநூல் பக்கத்தி���் அடிப்படையில் ஒரு பாடம் திட்டம் உருவாக்கவும்.",
  ...
  imageWorksheet: {
    ...
    ta: "இந்த படத்திலிருந்��ு 5 கேள்விகளுடன் ஒரு பணித்தாளை உருவாக்கவும்.",
  ...
  multigradeLesson: {
    ...
    ta: "2 மற்றும் 3 ஆம் வகுப்புகளுக்கு 'இந்திய நாண��ம்' பற்றிய பாடம்.",
    gu: "ધોરણ 2 અને 3 માટે 'ભારતીય ચલણ' પર એક પાઠ.",
    kn: "2 మరియు 3 ನೇ ತರಗತಿಗಳಿಗೆ 'ಭಾರತೀಯ ಕರೆನ್ಸಿ' ಮೇಲೆ ಒಂದು ಪಾಠ.",
  },
  multigradeFood: {
  ...
  fieldTripHarappa: {
    ...
    gu: "હડપ્���ન સંસ્કૃતિના મુખ્ય કેન્દ્રોની 4-સ્ટોપ ટૂર.",
  ...
  fieldTripKaveri: {
    ...
    mr: "कावेरी नदीच्या उगमापासून समुद्रापर्य��तच्या प्रवासाचा ম���गोवा घ्या.",
  ...
  fieldTripTigers: {
    ...
    te: "పు���ుల సంరక్షణకు ప్రసిద్ధి చెందిన భారతదేశంలోని ప్రధాన జాతీయ ఉద్యానవనాల పర్యటన.",
  ...
  fieldTripFarming: {
    ...
    hi: "भ���रत में खेती: असम की चाय से केरल के मसालों तक।",
  ...
  trainingQuietStudents: {
    ...
    kn: "ನನ್ನ ವಿದ್ಯಾರ್ಥಿಗಳನ್ನು ಕೂಗದೆ ಸುಮ್ಮನಿರಿಸುವ���ದು ಹೇಗೆ?",
  },
  ...
  trainingMotivation: {
    ...
    ta: "நான் உந்துதல் இல்லாமல் உணர்கிறேன். நீங்கள் எனக்கு சில ஊக்��த்தை அளிக்க முடியுமா?",
  ...
  trainingTimeManagement: {
    ...
    te: "బహుళ గ్రేడ్‌లను బోధిస్తున్నప్పుడు నా సమయాన్ని న���ను ఎలా బాగా నిర్వహించ��లను?",
  ...
  rubricCholaProject: {
    ...
    hi: "8वीं कक्षा के छात्रों के लिए चोल रा���वंश पर एक शोध परियोजना।",
    ...
    kn: "8 ನೇ ತರಗತಿಯ ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಚೋಳ ರಾಜವಂಶದ ಮೇಲೆ ಸಂಶೋಧನಾ ಯೋ��ನೆ.",
  },
  rubricStorytelling: {
  ...
  rubricDebate: {
    ...
    hi: "10वीं कक्षा के छात्रों के लिए 'प्रौद��योगिकी अच्छी है या बुरी?' पर एक बहस।",
    ...
    kn: "10 ನೇ ತರಗತಿಯವರಿಗೆ 'ತಂತ್ರ��்ಞาน ಒಳ್ಳೆಯದೋ ಕೆಟ್ಟದ್ದೋ?' ಎಂಬ ವಿಷಯದ ಮೇಲೆ ಚರ್ಚೆ.",
  },
  rubricPoster: {
  ...
  quizIndianHistory: {
    ...
    ta: "இந்திய சுதந்திர இயக்கம் பற��றிய ஒரு சிறிய வினாடி வின��.",
  ...
  quizHumanBody: {
    ...
    ta: "5 ஆம் வகுப்���ுக்கு மனித உடலின் முக்கி�� உறுப்புகள் பற்றிய ஒரு வினாடி வினா.",
  ...
  quizBasicMath: {
    ...
    mr: "पहिलीच्या विद्यार्थ्यांसाठी बेरीज आणि वजाबाक���वर एक सोपी प्रश्नमंजुषा.",
  ...
  quizAboutIndia: {
    ...
    te: "భ���రతదేశ చరిత్ర గురించి 5-ప్రశ్నల క్విజ్‌ను రూపొందించండి.",
...
const headerTranslations: Record<string, string> = {
  ...
  te: "వీటిలో ఒకదాన్ని ప్రయత���నించండి",
      ...
      <div className="flex flex-wrap gap-2">
        {prompts.map((prompt, index) => (
          <Button
            ...
            variant="outline"
            size="sm"
            className="text-sm h-auto py-2 px-3 bg-white hover:bg-blue-50 hover:border-blue-300 border-gray-200 transition-colors"
