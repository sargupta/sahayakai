...
class QuizErrorView extends ConsumerWidget {
  const QuizErrorView({super.key, required this.error, this.onRetry});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (api.kind) {
      ...
      case ApiErrorKind.unauthorized:
        return ErrorView(message: l10n.quizSignIn);
      case ApiErrorKind.forbidden:
        return _PromptView(
          icon: LucideIcons.arrowUpCircle,
          title: l10n.quizUpgradeTitle,
          body: l10n.quizUpgradeBody,
          actionLabel: l10n.quizSeePricing,
          onAction: openPricing,
        );
      case ApiErrorKind.rateLimited:
        return _PromptView(
          icon: LucideIcons.hourglass,
          title: l10n.quizLimitTitle,
          body: l10n.quizLimitBody,
          actionLabel: l10n.quizSeePricing,
          onAction: openPricing,
        );
      case ApiErrorKind.timeout:
        return ErrorView(message: l10n.quizTimeout, onRetry: onRetry);
      case ApiErrorKind.server:
        return ErrorView(message: l10n.quizBusy, onRetry: onRetry);
      case ApiErrorKind.badResponse:
        final message =
            api.statusCode == 400 ? l10n.quizRephrase : l10n.errorGeneric;
