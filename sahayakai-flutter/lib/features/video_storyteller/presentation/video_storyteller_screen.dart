...
class _VideoStorytellerScreenState
  ...
  /// long finished by the time the recommendations land, so this is a single,
  ...
  void _maybeSpeakVoiceSummary(AppLocalizations l10n) {
    ...
    final summary = (topic == null || topic.isEmpty)
        ? l10n.voiceResultReady(l10n.videoStorytellerTitle)
        : l10n.voiceResultReadyWithTopic(l10n.videoStorytellerTitle, topic);
    speakResultSummary(
