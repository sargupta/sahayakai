...
/// decides whether the teacher should retry, rephrase, upgrade, wait or sign in.
///
...
class RubricErrorView extends StatelessWidget {
  const RubricErrorView({super.key, required this.error, this.onRetry});
  ...
  Widget build(BuildContext context) {
    ...
    switch (api.kind) {
      ...
      case ApiErrorKind.unauthorized:
        return ErrorView(message: l10n.rubricSignIn);
      case ApiErrorKind.forbidden:
        return _PromptView(
          icon: LucideIcons.arrowUpCircle,
          title: l10n.rubricUpgradeTitle,
          body: l10n.rubricUpgradeBody,
        );
      case ApiErrorKind.rateLimited:
        return _PromptView(
          icon: LucideIcons.hourglass,
          title: l10n.rubricLimitTitle,
          body: l10n.rubricLimitBody,
        );
      case ApiErrorKind.timeout:
        return ErrorView(message: l10n.rubricTimeout, onRetry: onRetry);
      case ApiErrorKind.server:
        return ErrorView(message: l10n.rubricBusy, onRetry: onRetry);
      case ApiErrorKind.badResponse:
        final message =
            api.statusCode == 400 ? l10n.rubricRephrase : l10n.errorGeneric;
