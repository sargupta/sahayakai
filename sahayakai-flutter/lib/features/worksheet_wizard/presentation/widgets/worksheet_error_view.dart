...
class WorksheetErrorView extends ConsumerWidget {
  const WorksheetErrorView({super.key, required this.error, this.onRetry});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (api.kind) {
      ...
      case ApiErrorKind.unauthorized:
        return ErrorView(message: l10n.worksheetSignIn);
      case ApiErrorKind.forbidden:
        return _PromptView(
          icon: LucideIcons.arrowUpCircle,
          title: l10n.worksheetUpgradeTitle,
          body: l10n.worksheetUpgradeBody,
          actionLabel: l10n.worksheetSeePricing,
          onAction: openPricing,
        );
      case ApiErrorKind.rateLimited:
        return _PromptView(
          icon: LucideIcons.hourglass,
          title: l10n.worksheetLimitTitle,
          body: l10n.worksheetLimitBody,
          actionLabel: l10n.worksheetSeePricing,
          onAction: openPricing,
        );
      case ApiErrorKind.timeout:
        return ErrorView(message: l10n.worksheetTimeout, onRetry: onRetry);
      case ApiErrorKind.server:
        return ErrorView(message: l10n.worksheetBusy, onRetry: onRetry);
      case ApiErrorKind.badResponse:
        final message =
            api.statusCode == 400 ? l10n.worksheetRephrase : l10n.errorGeneric;
