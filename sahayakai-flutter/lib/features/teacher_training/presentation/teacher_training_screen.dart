...
class _TeacherTrainingScreenState extends ConsumerState<TeacherTrainingScreen> {
  ...
  /// long finished by the time the advice lands, so this is a single,
  ...
  void _maybeSpeakVoiceSummary(AppLocalizations l10n) {
    ...
    final summary = (topic == null || topic.isEmpty)
        ? l10n.voiceResultReady(l10n.teacherTrainingTitle)
        : l10n.voiceResultReadyWithTopic(l10n.teacherTrainingTitle, topic);
    speakResultSummary(
