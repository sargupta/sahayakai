...
/// whether the teacher should retry, rephrase, upgrade, wait or sign in.
///
...
class TeacherTrainingErrorView extends ConsumerWidget {
  const TeacherTrainingErrorView({super.key, required this.error, this.onRetry});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (api.kind) {
      ...
      case ApiErrorKind.unauthorized:
        return ErrorView(message: l10n.teacherTrainingSignIn);

      case ApiErrorKind.forbidden:
        return _PromptView(
          icon: LucideIcons.arrowUpCircle,
          title: l10n.teacherTrainingUpgradeTitle,
          body: l10n.teacherTrainingUpgradeBody,
          actionLabel: l10n.teacherTrainingSeePricing,
      ...
      case ApiErrorKind.rateLimited:
        return _PromptView(
          ...
          title: l10n.teacherTrainingLimitTitle,
          body: l10n.teacherTrainingLimitBody,
          actionLabel: l10n.teacherTrainingSeePricing,
          onAction: openPricing,
        );

      case ApiErrorKind.timeout:
        return ErrorView(message: l10n.teacherTrainingTimeout, onRetry: onRetry);
      ...
      case ApiErrorKind.server:
        ...
        return ErrorView(
          message: seconds == null
              ? l10n.teacherTrainingBusy
              : l10n.teacherTrainingBusyRetryAfter(seconds),
          onRetry: onRetry,
        );

      case ApiErrorKind.badResponse:
        final message = api.statusCode == 400
            ? l10n.teacherTrainingRephrase
            : l10n.errorGeneric;
