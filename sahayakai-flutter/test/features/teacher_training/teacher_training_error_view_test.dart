...
/// Every failed request maps to the *right* recovery UI — retry, rephrase,
/// upgrade, wait or sign in — not one generic error. Pins the typed
/// [ApiException] -> widget mapping, including the 503 Retry-After branch.
void main() {
        ...
        child: MaterialApp(
          ...
          home: Scaffold(
            body: SingleChildScrollView(
              child: TeacherTrainingErrorView(error: error, onRetry: () {}),
            ),
          ),
        ),
      ),
  ...
  ApiException busyWithRetryAfter(int seconds) {
    final response = Response<dynamic>(
      requestOptions: RequestOptions(path: '/api/ai/teacher-training'),
      statusCode: 503,
