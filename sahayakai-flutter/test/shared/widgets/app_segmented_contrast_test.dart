...
/// on the track fill (`surfaceContainerHigh`), not the thumb — it previously
/// used `onSurfaceVariant`, which is only 3.86:1 on that fill (a fail for the
...
void main() {
  for (final brightness in Brightness.values) {
    testWidgets(
      ...
      final trackFill = theme.colorScheme.surfaceContainerHigh;
