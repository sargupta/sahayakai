  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Status tokens (Gate 11 prereq): success/warning/info give status
        // UI a tokenised alternative to raw green/amber/blue palette
        // classes, which the widened Gate 11 now bans.
        success: {
