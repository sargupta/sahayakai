...
export const NCERTScience: NCERTGrade[] = [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        chapters: [
            ...
            { id: 'sci-7-8',  number: 8,  title: 'Measurement of Time and Motion',            titleHindi: 'समय एवं गति का मापन',                 textbookName: 'Curiosity 7', learningOutcomes: ['Measure time with periodic events', 'Speed and its calculation'], keywords: ['time', 'motion', 'speed', 'measurement'], estimatedPeriods: 9 },
            { id: 'sci-7-9',  number: 9,  title: 'Life Processes in Animals',                 titleHindi: 'जंतुओं में जैव प्रक्रम',               textbookName: 'Curiosity 7', learningOutcomes: ['Nutrition and digestion in animals', 'Respiration and circulation basics'], keywords: ['life processes', 'animals', 'digestion', 'respiration'], estimatedPeriods: 10 },
            { id: 'sci-7-10', number: 10, title: 'Life Processes in Plants',                  titleHindi: 'पादपों में जैव प्रक्रम',               textbookName: 'Curiosity 7', learningOutcomes: ['Photosynthesis', 'Transport of water and food in plants'], keywords: ['life processes', 'plants', 'photosynthesis'], estimatedPeriods: 10 },
            { id: 'sci-7-11', number: 11, title: 'Light: Shadows and Reflections',            titleHindi: 'प्रकाश – छाया एवं परावर्तन',           textbookName: 'Curiosity 7', learningOutcomes: ['Formation of shadows', 'Reflection and plane mirrors'], keywords: ['light', 'shadow', 'reflection', 'mirror'], estimatedPeriods: 9 },
            { id: 'sci-7-12', number: 12, title: 'Earth, Moon, and the Sun',                  titleHindi: 'पृथ्वी, चन्द्रमा एवं सूर्य',           textbookName: 'Curiosity 7', learningOutcomes: ['Rotation and revolution', 'Eclipses and phases of the Moon'], keywords: ['earth', 'moon', 'sun', 'eclipse'], estimatedPeriods: 8 },
        ],
    },
    ...
    // -----------------------------------------------------------------------
    {
        ...
        subject: 'Science',
        chapters: [
            { id: 'sci-8-1', number: 1, title: 'Exploring the Investigative World of Science', titleHindi: 'विज्ञान की खोजी दुनिया', textbookName: 'Curiosity 8', learningOutcomes: ['Scientific method and investigation'], keywords: ['science', 'investigation', 'method'], estimatedPeriods: 8 },
            { id: 'sci-8-2', number: 2, title: 'The Invisible Living World: Beyond Our Naked Eye', titleHindi: 'अदृश्य जीवित संसार', textbookName: 'Curiosity 8', learningOutcomes: ['Microorganisms and the microscope'], keywords: ['microorganisms', 'microscope', 'cells'], estimatedPeriods: 10 },
            { id: 'sci-8-3', number: 3, title: 'Health: The Ultimate Treasure', titleHindi: 'स्वास्थ्य: परम निधि', textbookName: 'Curiosity 8', learningOutcomes: ['Health, hygiene and disease prevention'], keywords: ['health', 'hygiene', 'disease'], estimatedPeriods: 9 },
            { id: 'sci-8-4', number: 4, title: 'Electricity: Magnetic and Heating Effects', titleHindi: 'विद्युत: चुंबकीय एवं तापीय प्रभाव', textbookName: 'Curiosity 8', learningOutcomes: ['Magnetic and heating effects of current'], keywords: ['electricity', 'magnetism', 'heating effect'], estimatedPeriods: 10 },
            { id: 'sci-8-5', number: 5, title: 'Exploring Forces', titleHindi: 'बलों की खोज', textbookName: 'Curiosity 8', learningOutcomes: ['Types of forces and their effects'], keywords: ['force', 'motion'], estimatedPeriods: 9 },
            { id: 'sci-8-6', number: 6, title: 'Pressure, Winds, Storms, and Cyclones', titleHindi: 'दाब, पवनें, तूफान और चक्रवात', textbookName: 'Curiosity 8', learningOutcomes: ['Pressure and weather phenomena'], keywords: ['pressure', 'wind', 'cyclone'], estimatedPeriods: 9 },
            { id: 'sci-8-7', number: 7, title: 'Particulate Nature of Matter', titleHindi: 'पदार्थ की कणीय प्रकृति', textbookName: 'Curiosity 8', learningOutcomes: ['Particles of matter and their behaviour'], keywords: ['matter', 'particles', 'states'], estimatedPeriods: 9 },
            { id: 'sci-8-8', number: 8, title: 'Nature of Matter: Elements, Compounds, and Mixtures', titleHindi: 'तत्व, यौगिक और मिश्रण', textbookName: 'Curiosity 8', learningOutcomes: ['Classify matter into elements, compounds, mixtures'], keywords: ['elements', 'compounds', 'mixtures'], estimatedPeriods: 10 },
            { id: 'sci-8-9', number: 9, title: 'The Amazing World of Solutes, Solvents, and Solutions', titleHindi: 'विलेय, विलायक और विलयन', textbookName: 'Curiosity 8', learningOutcomes: ['Solutions and solubility'], keywords: ['solution', 'solute', 'solvent'], estimatedPeriods: 8 },
            { id: 'sci-8-10', number: 10, title: 'Light: Mirrors and Lenses', titleHindi: 'प्रकाश: दर्पण एवं लेंस', textbookName: 'Curiosity 8', learningOutcomes: ['Reflection and refraction with mirrors and lenses'], keywords: ['light', 'mirror', 'lens'], estimatedPeriods: 10 },
            { id: 'sci-8-11', number: 11, title: 'Keeping Time with the Skies', titleHindi: 'आकाश के साथ समय', textbookName: 'Curiosity 8', learningOutcomes: ['Celestial motion and calendars'], keywords: ['astronomy', 'time', 'sky'], estimatedPeriods: 8 },
            { id: 'sci-8-12', number: 12, title: 'How Nature Works in Harmony', titleHindi: 'प्रकृति का सामंजस्य', textbookName: 'Curiosity 8', learningOutcomes: ['Ecosystems and interdependence'], keywords: ['ecosystem', 'nature', 'balance'], estimatedPeriods: 8 },
            { id: 'sci-8-13', number: 13, title: 'Our Home: Earth, a Unique Life Sustaining Planet', titleHindi: 'हमारा घर: पृथ्वी', textbookName: 'Curiosity 8', learningOutcomes: ['Earth as a life-sustaining planet'], keywords: ['earth', 'planet', 'life'], estimatedPeriods: 8 },
        ],
    },
    ...
    // -----------------------------------------------------------------------
    {
        ...
        subject: 'Science',
        chapters: [
            // ── Exploration — NCF-2023 Class 9 Science, prescribed from 2026-27 ──
            ...
            { id: 'sci-9-exp-4', title: 'Describing Motion Around Us', titleHindi: 'गति का वर्णन', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 4, learningOutcomes: ['Distance, displacement, speed, velocity', 'Graphs of motion'], keywords: ['motion', 'velocity', 'graph'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-5', title: 'Exploring Mixtures and their Separation', titleHindi: 'मिश्रण और पृथक्करण', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 5, learningOutcomes: ['Types of mixtures and solutions', 'Separation techniques'], keywords: ['mixture', 'solution', 'separation'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-6', title: 'How Forces Affect Motion', titleHindi: 'बल और गति', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 6, learningOutcomes: ['Newton\'s laws of motion', 'Momentum and inertia'], keywords: ['force', 'newton', 'momentum'], estimatedPeriods: 14, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-7', title: 'Work, Energy, and Simple Machines', titleHindi: 'कार्य, ऊर्जा और सरल मशीनें', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 7, learningOutcomes: ['Work and energy transfer', 'Levers and mechanical advantage'], keywords: ['work', 'energy', 'machines'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-8', title: 'Journey Inside the Atom', titleHindi: 'परमाणु की संरचना', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 8, learningOutcomes: ['Sub-atomic particles', 'Atomic models and structure'], keywords: ['atom', 'electron', 'nucleus'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-9', title: 'Atomic Foundations of Matter', titleHindi: 'द्रव्य के परमाणु आधार', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 9, learningOutcomes: ['Atoms, molecules and mole concept', 'Chemical formulae'], keywords: ['mole', 'molecule', 'formula'], estimatedPeriods: 14, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-10', title: 'Sound Waves: Characteristics and Applications', titleHindi: 'ध्वनि', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 10, learningOutcomes: ['Wave properties of sound', 'Reflection, echo and applications'], keywords: ['sound', 'wave', 'echo'], estimatedPeriods: 10, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-11', title: 'Reproduction: How Life Continues', titleHindi: 'जनन', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 11, learningOutcomes: ['Asexual and sexual reproduction', 'Reproductive structures'], keywords: ['reproduction', 'gamete', 'fertilisation'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-12', title: 'Patterns in Life: Diversity and Classification', titleHindi: 'जैव विविधता और वर्गीकरण', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 12, learningOutcomes: ['Basis of biological classification', 'Hierarchy of taxa'], keywords: ['classification', 'diversity', 'taxonomy'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },
            { id: 'sci-9-exp-13', title: 'Earth as a System: Energy, Matter, and Life', titleHindi: 'पृथ्वी एक तंत्र', textbookName: 'Exploration', textbookEdition: 'NCF-2023', number: 13, learningOutcomes: ['Earth\'s spheres and their interaction', 'Biogeochemical cycles'], keywords: ['biosphere', 'cycles', 'earth system'], estimatedPeriods: 12, isActive: true, dataVersion: '2026-ncert-ncf-class9' },

            // ── Retired: Science (NCERT), Rationalized-2022 ──
    { id: 'sci-9-1',  number: 1,  title: 'Matter in Our Surroundings',         titleHindi: 'हमारे आस-पास के पदार्थ',              textbookName: 'Science (NCERT)', learningOutcomes: ['States of matter', 'Changes of state and their conditions'], keywords: ['matter', 'solid', 'liquid', 'gas', 'states'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-2',  number: 2,  title: 'Is Matter Around Us Pure?',           titleHindi: 'क्या हमारे आस-पास के पदार्थ शुद्ध हैं?', textbookName: 'Science (NCERT)', learningOutcomes: ['Mixtures and compounds', 'Separation methods', 'Colloids and suspensions'], keywords: ['pure', 'mixture', 'compound', 'colloid'], estimatedPeriods: 10, isActive: false },
            { id: 'sci-9-3',  number: 3,  title: 'Atoms and Molecules',                 titleHindi: 'परमाणु एवं अणु',                      textbookName: 'Science (NCERT)', learningOutcomes: ['Dalton\'s atomic theory', 'Atomic mass and molar mass', 'Chemical formulae'], keywords: ['atoms', 'molecules', 'atomic mass', 'formulae'], estimatedPeriods: 14, isActive: false },
            { id: 'sci-9-4',  number: 4,  title: 'Structure of the Atom',               titleHindi: 'परमाणु की संरचना',                     textbookName: 'Science (NCERT)', learningOutcomes: ['Subatomic particles', 'Bohr\'s model', 'Electronic configuration'], keywords: ['electron', 'proton', 'neutron', 'atomic structure'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-5',  number: 5,  title: 'The Fundamental Unit of Life',        titleHindi: 'जीवन की मौलिक इकाई',                  textbookName: 'Science (NCERT)', learningOutcomes: ['Cell structure and organelles', 'Differences between plant and animal cells'], keywords: ['cell', 'organelles', 'nucleus', 'membrane'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-6',  number: 6,  title: 'Tissues',                             titleHindi: 'ऊतक',                                 textbookName: 'Science (NCERT)', learningOutcomes: ['Plant and animal tissues', 'Types and functions of tissues'], keywords: ['tissues', 'epithelial', 'meristematic', 'muscle'], estimatedPeriods: 10, isActive: false },
            { id: 'sci-9-7',  number: 7,  title: 'Motion',                              titleHindi: 'गति',                                 textbookName: 'Science (NCERT)', learningOutcomes: ['Distance, displacement, speed, velocity', 'Equations of uniformly accelerated motion'], keywords: ['motion', 'acceleration', 'velocity', 'distance'], estimatedPeriods: 14, isActive: false },
            { id: 'sci-9-8',  number: 8,  title: 'Force and Laws of Motion',            titleHindi: 'बल तथा गति के नियम',                  textbookName: 'Science (NCERT)', learningOutcomes: ['Newton\'s three laws of motion', 'Inertia and momentum'], keywords: ['force', 'inertia', 'Newton', 'momentum'], estimatedPeriods: 14, isActive: false },
            { id: 'sci-9-9',  number: 9,  title: 'Gravitation',                         titleHindi: 'गुरुत्वाकर्षण',                        textbookName: 'Science (NCERT)', learningOutcomes: ['Universal law of gravitation', 'Free fall and acceleration due to gravity'], keywords: ['gravity', 'acceleration', 'gravitation', 'free fall'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-10', number: 10, title: 'Work and Energy',                     titleHindi: 'कार्य तथा ऊर्जा',                      textbookName: 'Science (NCERT)', learningOutcomes: ['Potential and kinetic energy', 'Work-energy theorem', 'Power'], keywords: ['work', 'energy', 'power', 'kinetic', 'potential'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-11', number: 11, title: 'Sound',                               titleHindi: 'ध्वनि',                               textbookName: 'Science (NCERT)', learningOutcomes: ['Propagation of sound', 'Frequency, amplitude, wavelength', 'Echo and reverberation'], keywords: ['sound', 'echo', 'frequency', 'wavelength'], estimatedPeriods: 12, isActive: false },
            { id: 'sci-9-12', number: 12, title: 'Improvement in Food Resources',      titleHindi: 'खाद्य संसाधनों में सुधार',             textbookName: 'Science (NCERT)', learningOutcomes: ['Crops and animal husbandry', 'Sustainable farming practices'], keywords: ['agriculture', 'livestock', 'food resources', 'farming'], estimatedPeriods: 10, isActive: false },
        ],
    },
    {
        grade: 10,
...
export const evsChapters: NCERTChapter[] = NCERTScience
    ...
    .flatMap(g => g.chapters.map(c => ({
        ...
        textbookEdition: (c.textbookEdition ?? 'NCF-2023') as 'NCF-2023',
        isActive: c.isActive ?? true,
        dataVersion: c.dataVersion ?? '2025-ncert-ncf',
    })));
...
export const scienceChapters: NCERTChapter[] = NCERTScience
    ...
    .flatMap(g => g.chapters.map(c => ({
        ...
        // Every field the chapter declares wins. Hardcoding these meant no
        // Science chapter could ever be retired, and a grade holding both a
        // retired and a current book got one edition stamped on both.
        textbookEdition: (c.textbookEdition ?? (g.grade <= 8 ? 'NCF-2023' : 'Rationalized-2022')) as 'NCF-2023' | 'Rationalized-2022',
        isActive: c.isActive ?? true,
