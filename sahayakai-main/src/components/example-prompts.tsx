...
const promptTranslations: Record<string, Record<string, string>> = {
  waterCycle: {
    ...
    pa: "ਜਲ ਚੱਕਰ 'ਤੇ ਇੱਕ ਪਾਠ ਯੋਜਨਾ",
    ml: "ജലചക്രത്തെക്കുറിച്ചുള്ള ഒരു പാഠ്യപദ്ധതി",
    or: "ଜଳ ଚକ୍ର ଉପରେ ଏକ ପାଠ ଯୋଜନା",
  },
  skyBlue: {
    ...
    pa: "ਆਸਮਾਨ ਨੀਲਾ ਕਿਉਂ ਹੈ?",
    ml: "ആകാശം നീലയായിരിക്കുന്നത് എന്തുകൊണ്ട്?",
    or: "ଆକାଶ କାହିଁକି ନୀଳ?",
  },
  hibiscusDiagram: {
    ...
    pa: "ਜਮਾਤ 4 ਲਈ ਗੁੜ੍ਹਲ ਦੇ ਹਿੱਸਿਆਂ ਦਾ ਇੱਕ ਸਧਾਰਨ ਚਿੱਤਰ ਬਣਾਓ",
    ml: "നാലാം ക്ലാസുകാർക്കായി ചെമ്പരത്തിയുടെ ഭാഗങ്ങളുടെ ഒരു ലളിതമായ ചിത്രം വരയ്ക്കുക",
    or: "ଚତୁର୍ଥ ଶ୍ରେଣୀ ପାଇଁ ମନ୍ଦାର ଫୁଲର ବିଭିନ୍ନ ଅଂଶର ଏକ ସରଳ ଚିତ୍ର ଅଙ୍କନ କରନ୍ତୁ",
  },
  braveMouse: {
    ...
    pa: "ਜਮਾਤ 2 ਲਈ ਇੱਕ ਬਹਾਦਰ ਚੂਹੇ ਦੀ ਇੱਕ ਛੋਟੀ ਕਹਾਣੀ",
    ml: "രണ്ടാം ക്ലാസുകാർക്കായി ഒരു ധീരനായ എലിയെക്കുറിച്ചുള്ള ലഘു കഥ",
    or: "ଦ୍ୱିତୀୟ ଶ୍ରେଣୀ ପାଇଁ ଏକ ସାହସୀ ମୂଷାର ଏକ କ୍ଷୁଦ୍ର ଗଳ୍ପ",
  },
  visualAidFlower: {
    ...
    pa: "ਫੁੱਲ ਦਾ ਇੱਕ ਸਧਾਰਨ ਚਿੱਤਰ ਜੋ ਇਸਦੇ ਮੁੱਖ ਭਾਗਾਂ ਨੂੰ ਦਰਸਾਉਂਦਾ ਹੈ: ਜੜ੍ਹ, ਤਣਾ, ਪੱਤਾ ਅਤੇ ਪੰਖੜੀ।",
    ml: "വേര്, തണ്ട്, ഇല, ഇതൾ തുടങ്ങിയ പ്രധാന ഭാഗങ്ങൾ കാണിക്കുന്ന പൂവിന്റെ ലളിതമായ ചിത്രം.",
    or: "ଏକ ଫୁଲର ସରଳ ଚିତ୍ର ଯେଉଁଥିରେ ମୁଖ୍ୟ ଅଂଶ ଦର୍ଶାଯାଇଛି: ମୂଳ, କାଣ୍ଡ, ପତ୍ର ଏବଂ ପାଖୁଡ଼ା |",
  },
  visualAidWaterCycle: {
    ...
    pa: "ਵਾਸ਼ਪੀਕਰਨ, ਸੰਘਣਾਪਣ ਅਤੇ ਵਰਖਾ ਦੇ ਲੇਬਲ ਦੇ ਨਾਲ ਜਲ ਚੱਕਰ ਦਰਸਾਉਂਦਾ ਇੱਕ ਚਿੱਤਰ।",
    ml: "ബാഷ്പീകരണം, ഘനീഭവിക്കൽ, മഴ എന്നിവയുടെ ലേബലുകളോടുകൂടിയ ജലചക്രം കാണിക്കുന്ന ചിത്രം.",
    or: "ବାଷ୍ପୀକରଣ, ଘନୀକରଣ ଏବଂ ବୃଷ୍ଟିପାତ ପାଇଁ ଲେବଲ୍ ସହିତ ଜଳ ଚକ୍ର ଦର୍ଶାଉଥିବା ଏକ ଚିତ୍ର |",
  },
  visualAidHeart: {
    ...
    pa: "ਚਾਰ ਚੈਂਬਰਾਂ ਵਾਲੇ ਮਨੁੱਖੀ ਦਿਲ ਦਾ ਇੱਕ ਸਧਾਰਨ ਚਿੱਤਰ।",
    ml: "നാല് അറകളുള്ള മനുഷ്യഹൃദയത്തിന്റെ ലളിതമായ ചിത്രം.",
    or: "ଚାରୋଟି ପ୍ରକୋଷ୍ଠ ସହିତ ମାନବ ହୃଦୟର ଏକ ସରଳ ଚିତ୍ର |",
  },
  explainPhotosynthesis: {
    ...
    pa: "ਪੋਂਗਲ ਕਿਵੇਂ ਬਣਦਾ ਹੈ, ਇਸਦੀ ਉਦਾਹਰਣ ਵਰਤ ਕੇ ਪ੍ਰਕਾਸ਼ ਸੰਸ਼ਲੇਸ਼ਣ ਦੀ ਵਿਆਖਿਆ ਕਰੋ।",
    ml: "പൊങ്കൽ എങ്ങനെ ഉണ്ടാക്കുന്നു എന്ന ഉദാഹരണത്തിലൂടെ പ്രകാശസംശ്ലേഷണം വിശദീകരിക്കുക.",
    or: "ପୋଙ୍ଗଲ୍ କିପରି ତିଆରି ହୁଏ ତାର ଉଦାହରଣ ଦେଇ ଆଲୋକ ସଂଶ୍ଳେଷଣ ବୁଝାନ୍ତୁ |",
  },
  nalandaHistory: {
    ...
    pa: "ਨਾਲੰਦਾ ਯੂਨੀਵਰਸਿਟੀ ਦੇ ਇਤਿਹਾਸ ਬਾਰੇ ਦੱਸੋ।",
    ml: "നളന്ദ സർവ്വകലാശാലയുടെ ചരിത്രത്തെക്കുറിച്ച് പറയുക.",
    or: "ନାଳନ୍ଦା ବିଶ୍ୱବିଦ୍ୟାଳୟର ଇତିହାସ ବିଷୟରେ କୁହନ୍ତୁ |",
  },
  indianRivers: {
    ...
    pa: "ਭਾਰਤ ਦੀਆਂ ਪ੍ਰਮੁੱਖ ਨਦੀਆਂ ਕਿਹੜੀਆਂ ਹਨ?",
    ml: "ഇന്ത്യയിലെ പ്രധാന നദികൾ ഏവ?",
    or: "ଭାରତର ପ୍ରମୁଖ ନଦୀ ଗୁଡ଼ିକ କଣ କଣ?",
  },
  worksheetFillInBlanks: {
    ...
    pa: "ਇਸ ਪੰਨੇ ਤੋਂ, ਜਮਾਤ 2 ਲਈ 5 ਖਾਲੀ ਥਾਵਾਂ ਭਰੋ ਪ੍ਰਸ਼ਨ ਬਣਾਓ।",
    ml: "ഈ പേജിൽ നിന്ന്, രണ്ടാം ക്ലാസുകാർക്കായി 5 പൂരിപ്പിക്കാനുള്ള ചോദ്യങ്ങൾ തയ്യാറാക്കുക.",
    or: "ଏହି ପୃଷ୍ଠାରୁ, ଦ୍ୱିତୀୟ ଶ୍ରେଣୀ ପାଇଁ ୫ଟି ଶୂନ୍ୟସ୍ଥାନ ପୂରଣ ପ୍ରଶ୍ନ ତିଆରି କରନ୍ତୁ |",
  },
  worksheetMatchFollowing: {
    ...
    pa: "ਇਸ ਪੰਨੇ ਤੋਂ ਜਾਨਵਰਾਂ ਦੇ ਨਾਮ ਅਤੇ ਉਹਨਾਂ ਦੀਆਂ ਆਵਾਜ਼ਾਂ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਜਮਾਤ 1 ਲਈ 'ਮਿਲਾਨ ਕਰੋ' ਗਤੀਵਿਧੀ ਬਣਾਓ।",
    ml: "ഈ പേജിലെ മൃഗങ്ങളുടെ പേരുകളും ശബ്ദങ്ങളും ഉപയോഗിച്ച് ഒന്നാം ക്ലാസുകാർക്കായി 'ചേരുംപടി ചേർക്കുക' പ്രവർത്തനം ഉണ്ടാക്കുക.",
    or: "ଏହି ପୃଷ୍ଠାରୁ ପଶୁମାନଙ୍କର ନାମ ଏବଂ ସେମାନଙ୍କର ଶବ୍ଦ ବ୍ୟବହାର କରି ପ୍ରଥମ ଶ୍ରେଣୀ ପାଇଁ 'ନିମ୍ନଲିଖିତ କୁ ମିଳାନ୍ତୁ' କାର୍ଯ୍ୟକଳାପ ତିଆରି କରନ୍ତୁ |",
  },
  worksheetWordSearch: {
    ...
    pa: "ਜਮਾਤ 3 ਲਈ, ਇਸ ਪੰਨੇ 'ਤੇ ਔਖੇ ਸ਼ਬਦਾਂ ਨਾਲ ਇੱਕ ਸ਼ਬਦ ਖੋਜ ਪਹੇਲੀ ਬਣਾਓ।",
    ml: "മൂന്നാം ക്ലാസുകാർക്കായി, ഈ പേജിലെ കഠിനമായ വാക്കുകൾ ഉപയോഗിച്ച് ഒരു പദപ്രശ്നം തയ്യാറാക്കുക.",
    or: "ତୃତୀୟ ଶ୍ରେଣୀ ପାଇଁ, ଏହି ପୃଷ୍ଠାର କଠିନ ଶବ୍ଦଗୁଡ଼ିକ ସହିତ ଏକ ଶବ୍ଦ ସନ୍ଧାନ ପହେଳି ତିଆରି କରନ୍ତୁ |",
  },
  imageLessonPlan: {
    ...
    pa: "ਇਸ ਪਾਠ ਪੁਸਤਕ ਦੇ ਪੰਨੇ ਦੇ ਆਧਾਰ 'ਤੇ ਇੱਕ ਪਾਠ ਯੋਜਨਾ ਬਣਾਓ।",
    ml: "ഈ പാഠപുസ്തക പേജിനെ അടിസ്ഥാനമാക്കി ഒരു പാഠ്യപദ്ധതി തയ്യാറാക്കുക.",
    or: "ଏହି ପାଠ୍ୟପୁସ୍ତକ ପୃଷ୍ଠା ଉପରେ ଆଧାରିତ ଏକ ପାଠ ଯୋଜନା ତିଆରି କରନ୍ତୁ |",
  },
  imageWorksheet: {
    ...
    pa: "ਇਸ ਚਿੱਤਰ ਤੋਂ 5 ਪ੍ਰਸ਼ਨਾਂ ਵਾਲੀ ਇੱਕ ਵਰਕਸ਼ੀਟ ਬਣਾਓ।",
    ml: "ഈ ചിത്രത്തിൽ നിന്ന് 5 ചോദ്യങ്ങളുള്ള ഒരു വർക്ക്ഷീറ്റ് തയ്യാറാക്കുക.",
    or: "ଏହି ଚିତ୍ରରୁ ୫ଟି ପ୍ରଶ୍ନ ସହିତ ଏକ ୱାର୍କସିଟ୍ ତିଆରି କରନ୍ତୁ |",
  },
  multigradeLesson: {
    ...
    pa: "ਜਮਾਤ 2 ਅਤੇ 3 ਲਈ 'ਭਾਰਤੀ ਮੁਦਰਾ' 'ਤੇ ਇੱਕ ਪਾਠ।",
    ml: "രണ്ടും മൂന്നും ക്ലാസുകൾക്കായി 'ഇന്ത്യൻ കറൻസി' എന്ന വിഷയത്തിൽ ഒരു പാഠം.",
    or: "ଦ୍ୱିତୀୟ ଏବଂ ତୃତୀୟ ଶ୍ରେଣୀ ପାଇଁ 'ଭାରତୀୟ ମୁଦ୍ରା' ଉପରେ ଏକ ପାଠ |",
  },
  multigradeFood: {
    ...
    pa: "ਜਮਾਤ 1, 2 ਅਤੇ 3 ਲਈ 'ਸਿਹਤਮੰਦ ਭੋਜਨ' 'ਤੇ ਇੱਕ ਪਾਠ।",
    ml: "ഒന്ന്, രണ്ട്, മൂന്ന് ക്ലാസുകൾക്കായി 'ആരോഗ്യകരമായ ഭക്ഷണം' എന്ന വിഷയത്തിൽ ഒരു പാഠം.",
    or: "ପ୍ରଥମ, ଦ୍ୱିତୀୟ ଏବଂ ତୃତୀୟ ଶ୍ରେଣୀ ପାଇଁ 'ସ୍ୱାସ୍ଥ୍ୟକର ଖାଦ୍ୟ' ଉପରେ ଏକ ପାଠ |",
  },
  fieldTripHarappa: {
    ...
    pa: "ਹੜੱਪਾ ਸਭਿਅਤਾ ਦੇ ਪ੍ਰਮੁੱਖ ਕੇਂਦਰਾਂ ਦਾ 4-ਸਟਾਪ ਦੌਰਾ।",
    ml: "ഹാരപ്പൻ സംസ്കാരത്തിന്റെ പ്രധാന കേന്ദ്രങ്ങളിലേക്കുള്ള 4-സ്റ്റോപ്പ് സന്ദർശനം.",
    or: "ହରପ୍ପା ସଭ୍ୟତାର ପ୍ରମୁଖ କେନ୍ଦ୍ରଗୁଡ଼ିକର ଏକ ୪-ଷ୍ଟପ୍ ଯାତ୍ରା |",
  },
  fieldTripKaveri: {
    ...
    pa: "ਕਾਵੇਰੀ ਨਦੀ ਦੀ ਉਸਦੇ ਸਰੋਤ ਤੋਂ ਸਮੁੰਦਰ ਤੱਕ ਦੀ ਯਾਤਰਾ ਦਾ ਪਤਾ ਲਗਾਓ।",
    ml: "കാവേരി നദിയുടെ ഉത്ഭവം മുതൽ കടൽ വരെയുള്ള യാത്ര കണ്ടെത്തുക.",
    or: "କାବେରୀ ନଦୀର ଉତ୍ସରୁ ସମୁଦ୍ର ପର୍ଯ୍ୟନ୍ତ ଯାତ୍ରା ଅନୁସନ୍ଧାନ କରନ୍ତୁ |",
  },
  fieldTripTigers: {
    ...
    pa: "ਬਾਘ ਸੁਰੱਖਿਆ ਲਈ ਮਸ਼ਹੂਰ ਭਾਰਤ ਦੇ ਪ੍ਰਮੁੱਖ ਰਾਸ਼ਟਰੀ ਪਾਰਕਾਂ ਦਾ ਦੌਰਾ।",
    ml: "കടുവ സംരക്ഷണത്തിന് പേരുകേട്ട ഇന്ത്യയിലെ പ്രധാന ദേശീയ പാർക്കുകളിലേക്കുള്ള യാത്ര.",
    or: "ବାଘ ସଂରକ୍ଷଣ ପାଇଁ ପ୍ରସିଦ୍ଧ ଭାରତର ପ୍ରମୁଖ ଜାତୀୟ ଉଦ୍ୟାନଗୁଡ଼ିକର ଭ୍ରମଣ |",
  },
  fieldTripFarming: {
    ...
    pa: "ਭਾਰਤ ਵਿੱਚ ਖੇਤੀ: ਅਸਾਮ ਦੀ ਚਾਹ ਤੋਂ ਕੇਰਲ ਦੇ ਮਸਾਲਿਆਂ ਤੱਕ।",
    ml: "ഇന്ത്യയിലെ കൃഷി: അസമിലെ തേയില മുതൽ കേരളത്തിലെ സുഗന്ധവ്യഞ്ജനങ്ങൾ വരെ.",
    or: "ଭାରତରେ କୃଷି: ଆସାମର ଚା ଠାରୁ କେରଳର ମସଲା ପର୍ଯ୍ୟନ୍ତ |",
  },
  trainingQuietStudents: {
    ...
    pa: "ਮੈਂ ਆਪਣੇ ਵਿਦਿਆਰਥੀਆਂ ਨੂੰ ਬਿਨਾਂ ਚੀਕਣ ਦੇ ਸ਼ਾਂਤ ਕਿਵੇਂ ਕਰ ਸਕਦਾ ਹਾਂ?",
    ml: "ശബ്ദമുണ്ടാക്കാതെ എനിക്ക് എങ്ങനെ വിദ്യാർത്ഥികളെ നിശബ്ദരാക്കാം?",
    or: "ମୁଁ ମୋର ଛାତ୍ରମାନଙ୍କୁ ପାଟି ନକରି କିପରି ଶାନ୍ତ କରିପାରିବି?",
  },
  trainingThinkPairShare: {
    ...
    pa: "ਵਿਗਿਆਨ ਦੇ ਪਾਠ ਲਈ 'ਸੋਚੋ-ਜੋੜੀ-ਸਾਂਝਾ ਕਰੋ' ਵਿਧੀ ਦੀ ਵਿਆਖਿਆ ਕਰੋ।",
    ml: "ഒരു സയൻസ് പാഠത്തിനായി 'ചിന്തിക്കുക-ജോടിയാക്കുക-പങ്കിടുക' എന്ന രീതി വിശദീകരിക്കുക.",
    or: "ବିଜ୍ଞାନ ପାଠ ପାଇଁ 'ଚିନ୍ତା-ଯୋଡି-ସେୟାର' ପଦ୍ଧତି ବ୍ୟାଖ୍ୟା କରନ୍ତୁ |",
  },
  trainingMotivation: {
    ...
    pa: "ਮੈਂ ਬੇਪਰਵਾਹ ਮਹਿਸੂਸ ਕਰ ਰਿਹਾ ਹਾਂ। ਕੀ ਤੁਸੀਂ ਮੈਨੂੰ ਕੁਝ ਹੌਂਸਲਾ ਦੇ ਸਕਦੇ ਹੋ?",
    ml: "എനിക്ക് പ്രചോദനം തോന്നുന്നില്ല. നിങ്ങൾക്ക് എനിക്ക് കുറച്ച് പ്രോത്സാഹനം നൽകാൻ കഴിയുമോ?",
    or: "ମୁଁ ଅନୁପ୍ରାଣିତ ଅନୁଭବ କରୁନାହିଁ | ଆପଣ ମୋତେ କିଛି ଉତ୍ସାହ ଦେଇପାରିବେ କି?",
  },
  trainingTimeManagement: {
    ...
    pa: "ਕਈ ਜਮਾਤਾਂ ਪੜ੍ਹਾਉਂਦੇ ਸਮੇਂ ਮੈਂ ਆਪਣੇ ਸਮੇਂ ਦਾ ਬਿਹਤਰ ਪ੍ਰਬੰਧਨ ਕਿਵੇਂ ਕਰ ਸਕਦਾ ਹਾਂ?",
    ml: "ഒന്നിലധികം ക്ലാസുകൾ കൈകാര്യം ചെയ്യുമ്പോൾ എനിക്ക് എങ്ങനെ സമയം നന്നായി വിനിയോഗിക്കാം?",
    or: "ଏକାଧିକ ଶ୍ରେଣୀ ପଢାଇବା ସମୟରେ ମୁଁ ମୋର ସମୟକୁ କିପରି ଭଲ ଭାବରେ ପରିଚାଳନା କରିପାରିବି?",
  },
  rubricCholaProject: {
    ...
    pa: "8ਵੀਂ ਜਮਾਤ ਦੇ ਵਿਦਿਆਰਥੀਆਂ ਲਈ ਚੋਲ ਰਾਜਵੰਸ਼ 'ਤੇ ਇੱਕ ਖੋਜ ਪ੍ਰੋਜੈਕਟ।",
    ml: "എട്ടാം ക്ലാസ് വിദ്യാർത്ഥികൾക്കായി ചോള രാജവംശത്തെക്കുറിച്ചുള്ള ഒരു ഗവേഷണ പ്രോജക്റ്റ്.",
    or: "ଅଷ୍ଟମ ଶ୍ରେଣୀର ଛାତ୍ରମାନଙ୍କ ପାଇଁ ଚୋଳ ରାଜବଂଶ ଉପରେ ଏକ ଗବେଷଣା ପ୍ରକଳ୍ପ |",
  },
  rubricStorytelling: {
    ...
    pa: "ਤੀਜੀ ਜਮਾਤ ਲਈ ਕਹਾਣੀ ਸੁਣਾਉਣ ਦਾ ਕੰਮ।",
    ml: "മൂന്നാം ക്ലാസുകാർക്കായി ഒരു കഥ പറയൽ അസൈൻമെന്റ്.",
    or: "ତୃତୀୟ ଶ୍ରେଣୀ ପାଇଁ ଏକ କାହାଣୀ କହିବା କାର୍ଯ୍ୟ |",
  },
  rubricDebate: {
    ...
    pa: "10ਵੀਂ ਜਮਾਤ ਦੇ ਵਿਦਿਆਰਥੀਆਂ ਲਈ 'ਕੀ ਤਕਨਾਲੋਜੀ ਚੰਗੀ ਹੈ ਜਾਂ ਮਾੜੀ?' 'ਤੇ ਬਹਿਸ।",
    ml: "പത്താം ക്ലാസുകാർക്കായി 'സാങ്കേതികവിദ്യ നല്ലതോ ചീത്തയോ?' എന്ന വിഷയത്തിൽ ഒരു സംവാദം.",
    or: "ଦଶମ ଶ୍ରେଣୀର ଛାତ୍ରମାନଙ୍କ ପାଇଁ 'ଟେକ୍ନୋଲୋଜି ଭଲ ନା ଖରାପ?' ଉପରେ ଏକ ବିତର୍କ |",
  },
  rubricPoster: {
    ...
    pa: "ਜਮਾਤ 5 ਲਈ 'ਪਾਣੀ ਬਚਾਓ' 'ਤੇ ਪੋਸਟਰ ਬਣਾਉਣ ਦੀ ਗਤੀਵਿਧੀ।",
    ml: "അഞ്ചാം ക്ലാസുകാർക്കായി 'ജലസംരക്ഷണം' എന്ന വിഷയത്തിൽ പോസ്റ്റർ നിർമ്മാണ പ്രവർത്തനം.",
    or: "ପଞ୍ଚମ ଶ୍ରେଣୀ ପାଇଁ 'ଜଳ ସଞ୍ଚୟ' ଉପରେ ଏକ ପୋଷ୍ଟର ତିଆରି କାର୍ଯ୍ୟକଳାପ |",
  },
  quizSolarSystem: {
    ...
    pa: "ਸਾਡੇ ਸੂਰਜੀ ਮੰਡਲ ਦੇ ਗ੍ਰਹਿਆਂ ਬਾਰੇ ਇੱਕ ਕਵਿਜ਼।",
    ml: "നമ്മുടെ സൗരയൂഥത്തിലെ ഗ്രഹങ്ങളെക്കുറിച്ചുള്ള ഒരു ക്വിസ്.",
    or: "ଆମ ସୌର ମଣ୍ଡଳର ଗ୍ରହମାନଙ୍କ ବିଷୟରେ ଏକ କୁଇଜ୍ |",
  },
  quizIndianHistory: {
    ...
    pa: "ਭਾਰਤੀ ਸੁਤੰਤਰਤਾ ਅੰਦੋਲਨ 'ਤੇ ਇੱਕ ਛੋਟੀ ਕਵਿਜ਼।",
    ml: "ഇന്ത്യൻ സ്വാതന്ത്ര്യ സമരത്തെക്കുറിച്ചുള്ള ഒരു ലഘു ക്വിസ്.",
    or: "ଭାରତୀୟ ସ୍ୱାଧୀନତା ଆନ୍ଦୋଳନ ଉପରେ ଏକ କ୍ଷୁଦ୍ର କୁଇଜ୍ |",
  },
  quizHumanBody: {
    ...
    pa: "ਜਮਾਤ 5 ਲਈ ਮਨੁੱਖੀ ਸਰੀਰ ਦੇ ਪ੍ਰਮੁੱਖ ਅੰਗਾਂ 'ਤੇ ਇੱਕ ਕਵਿਜ਼।",
    ml: "അഞ്ചാം ക്ലാസുകാർക്കായി മനുഷ്യശരീരത്തിലെ പ്രധാന അവയവങ്ങളെക്കുറിച്ചുള്ള ഒരു ക്വിസ്.",
    or: "ପଞ୍ଚମ ଶ୍ରେଣୀ ପାଇଁ ମାନବ ଶରୀରର ମୁଖ୍ୟ ଅଙ୍ଗମାନଙ୍କ ଉପରେ ଏକ କୁଇଜ୍ |",
  },
  quizBasicMath: {
    ...
    pa: "ਪਹਿਲੀ ਜਮਾਤ ਦੇ ਵਿਦਿਆਰਥੀਆਂ ਲਈ ਜੋੜ ਅਤੇ ਘਟਾਓ 'ਤੇ ਇੱਕ ਸਧਾਰਨ ਕਵਿਜ਼।",
    ml: "ഒന്നാം ക്ലാസുകാർക്കായി സങ്കലനവും വ്യവകലനവും സംബന്ധിച്ച ലളിതമായ ക്വിസ്.",
    or: "ପ୍ରଥମ ଶ୍ରେଣୀ ଛାତ୍ରମାନଙ୍କ ପାଇଁ ଯୋଗ ଏବଂ ବିୟୋଗ ଉପରେ ଏକ ସରଳ କୁଇଜ୍ |",
  },
  quizAboutIndia: {
    ...
    pa: "ਭਾਰਤ ਦੇ ਇਤਿਹਾਸ ਬਾਰੇ 5-ਸਵਾਲਾਂ ਦੀ ਕਵਿਜ਼ ਬਣਾਓ।",
    ml: "ഇന്ത്യയുടെ ചരിത്രത്തെക്കുറിച്ച് 5 ചോദ്യങ്ങളുള്ള ക്വിസ് തയ്യാറാക്കുക.",
    or: "ଭାରତର ଇତିହାସ ବିଷୟରେ ୫-ପ୍ରଶ୍ନ ବିଶିଷ୍ଟ କୁଇଜ୍ ତିଆରି କରନ୍ତୁ |",
  },
};
