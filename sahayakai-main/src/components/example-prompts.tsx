...
type ExamplePromptsProps = {
  ...
  page?: 'home' | 'lesson-plan' | 'visual-aid' | 'instant-answer' | 'worksheet' | 'homeWithImage' | 'virtual-field-trip' | 'teacher-training' | 'rubric' | 'quiz';
};
...
const promptTranslations: Record<string, Record<string, string>> = {
  ...
  explainPhotosynthesis: {
    ...
    bn: "পোঙ্গল কিভাবে তৈরি হয় তার উদাহরণ দিয়ে সালোকসংশ্লেষণ ব্যাখ্যা কর।",
...
const headerTranslations: Record<string, string> = {
  ...
  pa: "ਇਹਨਾਂ ਵਿੱਚੋਂ ਇੱਕ ਅਜ਼ਮਾਓ",
  ml: "ഇവയിൽ ഒന്ന് പരീക്ഷിക്കുക",
  or: "ଏଥିମଧ୍ୟରୁ ଗୋଟିଏ ଚେଷ୍ଟା କରନ୍ତୁ",
};

const pagePrompts: Record<string, string[]> = {
  'home': ['waterCycle', 'sanskritShloka', 'itBinary', 'braveMouse'],
  // Lesson Planner: every prompt must be an actual lesson-plan topic.
  // Previously this page reused 'homeWithImage', which mixed in an
  // instant-answer ("Why is the sky blue?") and a quiz ("...quiz about
  // India's history") — neither is a lesson plan.
  'lesson-plan': ['waterCycle', 'multigradeFood', 'multigradeLesson', 'explainPhotosynthesis'],
