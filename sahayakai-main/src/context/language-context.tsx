...
const dictionary: Record<string, Record<Language, string>> = {
    ...
    "Add specific details (optional) — e.g., 'Absent Mon, Tue, Wed' or 'Scored 12/50 in Math test'": {
        "English": "Add specific details (optional) — e.g., 'Absent Mon, Tue, Wed' or 'Scored 12/50 in Math test'",
        "Hindi": "विशिष्ट विवरण जोड़ें (वैकल्पिक) — जैसे 'सोम, मंगल, बुध को अनुपस्थित' या 'गणित परीक्षण में 12/50 अंक'",
        "Kannada": "ನಿರ್ದಿಷ್ಟ ವಿವರಗಳನ್ನು ಸೇರಿಸಿ (ಐಚ್ಛಿಕ) — ಉದಾ. 'ಸೋಮ, ಮಂಗಳ, ಬುಧ ಗೈರುಹಾಜರ' ಅಥವಾ 'ಗಣಿತ ಪರೀಕ್ಷೆಯಲ್ಲಿ 12/50'",
        "Tamil": "குறிப்பிட்ட விவரங்களைச் சேர்க்கவும் (விருப்பம்) — எ.கா. 'திங், செவ், புத ஆகியவற்றில் வரவில்லை' அல்லது 'கணித தேர்வில் 12/50'",
        "Telugu": "నిర్దిష్ట వివరాలను జోడించండి (ఐచ్ఛికం) — ఉదా. 'సోమ, మంగళ, బుధ గైర్హాజరు' లేదా 'గణిత పరీక్షలో 12/50'",
        "Marathi": "विशिष्ट तपशील जोडा (पर्यायी) — उदा. 'सोम, मंगळ, बुध अनुपस्थित' किंवा 'गणित चाचणीत 12/50'",
        "Bengali": "নির্দিষ্ট বিবরণ যোগ করুন (ঐচ্ছিক) — যেমন 'সোম, মঙ্গল, বুধ অনুপস্থিত' বা 'গণিত পরীক্ষায় 12/50'",
        "Gujarati": "ચોક્કસ વિગતો ઉમેરો (વૈકલ્પિક) — દા.ત. 'સોમ, મંગળ, બુધ ગેરહાજર' અથવા 'ગણિત પરીક્ષણમાં 12/50'",
        "Punjabi": "ਖਾਸ ਵੇਰਵੇ ਜੋੜੋ (ਵਿਕਲਪਿਕ) — ਜਿਵੇਂ 'ਸੋਮ, ਮੰਗਲ, ਬੁੱਧ ਗੈਰਹਾਜ਼ਰ' ਜਾਂ 'ਗਣਿਤ ਟੈਸਟ ਵਿੱਚ 12/50'",
        "Malayalam": "നിർദ്ദിഷ്ട വിശദാംശങ്ങൾ ചേർക്കുക (ഓപ്ഷണൽ) — ഉദാ. 'തിങ്കൾ, ചൊവ്വ, ബുധൻ ഹാജരായില്ല' അല്ലെങ്കിൽ 'കണക്ക് ടെസ്റ്റിൽ 12/50'",
        "Odia": "ନିର୍ଦ୍ଦିଷ୍ଟ ବିବରଣୀ ଯୋଗ କରନ୍ତୁ (ବୈକଳ୍ପିକ) — ଯଥା 'ସୋମ, ମଙ୍ଗଳ, ବୁଧ ଅନୁପସ୍ଥିତ' କିମ୍ବା 'ଗଣିତ ପରୀକ୍ଷାରେ 12/50'"
    },
    "Could not load class": {
        "English": "Could not load class",
        "Hindi": "कक्षा लोड नहीं हो सकी",
        "Kannada": "ತರಗತಿಯನ್ನು ಲೋಡ್ ಮಾಡಲಾಗಲಿಲ್ಲ",
        "Tamil": "வகுப்பை ஏற்ற முடியவில்லை",
        "Telugu": "తరగతిని లోడ్ చేయలేకపోయాము",
        "Marathi": "वर्ग लोड करता आला नाही",
        "Bengali": "ক্লাস লোড করা যায়নি",
        "Gujarati": "વર્ગ લોડ કરી શકાયો નથી",
        "Punjabi": "ਜਮਾਤ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੀ",
        "Malayalam": "ക്ലാസ് ലോഡ് ചെയ്യാനായില്ല",
        "Odia": "କ୍ଲାସ୍ ଲୋଡ୍ ହୋଇପାରିଲା ନାହିଁ"
    },
    "Something went wrong — please refresh and try again.": {
        "English": "Something went wrong — please refresh and try again.",
        "Hindi": "कुछ गड़बड़ हो गई — कृपया रीफ्रेश करके पुनः प्रयास करें।",
        "Kannada": "ಏನೋ ತಪ್ಪಾಗಿದೆ — ದಯವಿಟ್ಟು ರಿಫ್ರೆಶ್ ಮಾಡಿ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
        "Tamil": "ஏதோ தவறு நடந்தது — மீண்டும் புதுப்பித்து முயற்சிக்கவும்.",
        "Telugu": "ఏదో పొరపాటు జరిగింది — దయచేసి రిఫ్రెష్ చేసి మళ్లీ ప్రయత్నించండి.",
        "Marathi": "काहीतरी चूक झाली — कृपया रिफ्रेश करून पुन्हा प्रयत्न करा.",
        "Bengali": "কিছু একটা ভুল হয়েছে — অনুগ্রহ করে রিফ্রেশ করে আবার চেষ্টা করুন।",
        "Gujarati": "કંઈક ખોટું થયું — કૃપા કરી રિફ્રેશ કરી ફરી પ્રયત્ન કરો.",
        "Punjabi": "ਕੁਝ ਗਲਤ ਹੋ ਗਿਆ — ਕਿਰਪਾ ਕਰਕੇ ਰਿਫ੍ਰੈਸ਼ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
        "Malayalam": "എന്തോ തെറ്റ് സംഭവിച്ചു — ദയവായി പുതുക്കി വീണ്ടും ശ്രമിക്കുക.",
        "Odia": "କିଛି ଭୁଲ୍ ଘଟିଛି — ଦୟାକରି ରିଫ୍ରେସ୍ କରି ପୁନର୍ବାର ଚେଷ୍ଟା କରନ୍ତୁ।"
    },
};
