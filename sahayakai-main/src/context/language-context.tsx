...
const dictionary: Record<string, Record<Language, string>> = {
    ...
    "Saving...": {
        "English": "Saving...", "Hindi": "सहेजा जा रहा है...", "Kannada": "ಉಳಿಸಲಾಗುತ್ತಿದೆ...", "Tamil": "சேமிக்கப்படுகிறது...", "Telugu": "సేవ్ చేస్తోంది...", "Marathi": "जतन करत आहे...", "Bengali": "সংরক্ষণ করা হচ্ছে...", "Gujarati": "સાચવી રહ્યું છે...", "Punjabi": "ਸੰਭਾਲ ਰਿਹਾ ਹੈ...", "Malayalam": "സേവ് ചെയ്യുന്നു...", "Odia": "ସଞ୍ଚୟ କରୁଅଛି..."
    },
    "Was this helpful?": {
