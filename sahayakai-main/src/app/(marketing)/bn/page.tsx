    ...
    return (
        <>
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">সহায়ক AI কী?</h2>
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">প্রধান ফিচারসমূহ</h2>
                <div className="space-y-4">
                    <div className="border-l-4 border-orange-500 pl-4">
                        <h3 className="font-semibold text-gray-900">AI পাঠ পরিকল্পনা</h3>
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                        <h3 className="font-semibold text-gray-900">কুইজ জেনারেটর</h3>
                        <p className="text-gray-600">
                            ব্লুমের ট্যাক্সোনমি অনুযায়ী MCQ, সংক্ষিপ্ত উত্তর এবং দীর্ঘ উত্তর প্রশ্ন তৈরি করুন।
                        </p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                        <h3 className="font-semibold text-gray-900">ওয়ার্কশীট তৈরি</h3>
                        <p className="text-gray-600">
                            বিষয়ভিত্তিক ওয়ার্কশীট — গণিত, বিজ্ঞান, ইংরেজি, বাংলা সহ সকল বিষয়।
                        </p>
                    </div>
                    <div className="border-l-4 border-purple-500 pl-4">
                        <h3 className="font-semibold text-gray-900">ভয়েস ইনপুট</h3>
                        <p className="text-gray-600">
            ...
            <section className="mb-10 bg-orange-50 rounded-lg p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-3">সহায়ক AI বিনামূল্যে ব্যবহার করুন</h2>
                <p className="text-gray-700 mb-4">
            ...
            <nav className="border-t pt-8 mt-8">
                <p className="text-sm text-gray-500 mb-4">অন্যান্য ভাষায় পড়ুন:</p>
