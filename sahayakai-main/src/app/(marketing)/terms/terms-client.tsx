...
export function TermsClient() {
    ...
    const tldr = [
        ...
        "Your data is stored on Google Cloud in India (Mumbai) and you control it.",
            ...
            >
                ...
                <article className="relative z-10 max-w-[720px] mx-auto px-6 sm:px-12 pb-16 font-body text-[15px] text-neutral-700 leading-[1.7]">
                    ...
                    <Section kicker="04" title="Privacy and student data (DPDP)">
                        ...
                        <p className="mt-3">
                            <strong>Data storage location.</strong> Your account data, records, and uploaded media are stored and processed on Google Cloud infrastructure located in India (the <em>asia-south1</em>, Mumbai region). Transient online-status and typing signals are processed in Singapore (<em>asia-southeast1</em>); these carry no personal content. AI inference is additionally performed through third-party providers (Google Gemini, Sarvam); we process only the minimal prompt data needed to generate your output and do not retain personal data on these third-party systems beyond the request lifecycle.
                        </p>
                        <p className="mt-3">
