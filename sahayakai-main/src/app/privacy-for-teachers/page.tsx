    ...
    return (
        <div className="w-full max-w-3xl mx-auto py-6 space-y-6">
            <div className="text-center space-y-3">
                ...
                <h1 className="font-headline tracking-tight text-3xl font-bold text-foreground">
            ...
            <div className="grid gap-4">
                <Card className="border-green-200/60 bg-green-50/40">
                    <CardContent className="p-6 flex gap-4">
                        ...
                        <div>
                            <h3 className="font-headline font-semibold text-green-900 text-lg mb-2">
                ...
                <Card className="rounded-xl shadow-soft">
                    <CardContent className="p-6 flex gap-4">
                        <div className="shrink-0 mt-1 bg-primary/8 rounded-lg p-1.5">
                            <Lock className="h-6 w-6 text-primary" />
                        </div>
                        <div>
                            <h3 className="font-headline font-semibold text-foreground text-lg mb-2">
