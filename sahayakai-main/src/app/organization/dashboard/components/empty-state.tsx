...
export function EmptyStateDashboard({ reason, principalName, orgName, isDemoData }: Props) {
    ...
    const heading = firstName
        ? t('Welcome, {name}').replace('{name}', firstName)
        : t('Welcome to SahayakAI');

    const subline = orgName
        ? orgName
        : reason === 'no-org'
        ? t('Finish setting up your school to see your dashboard.')
        : t('Your school-wide analytics will appear here once a few teachers are active.');
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="rounded-2xl border-primary/30">
                    <CardHeader>
                        ...
                        <CardTitle className="text-base">{t('Invite your teachers')}</CardTitle>
                        <CardDescription className="text-xs">
                            {t('Real analytics start once 3 or more teachers are using SahayakAI. Most schools invite a pilot group of 5 first.')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="rounded-2xl">
                    <CardHeader>
                        ...
                        <CardTitle className="text-base">{t('Try the product yourself')}</CardTitle>
                        <CardDescription className="text-xs">
                            {t('Generate a lesson plan, quiz, or worksheet the same way your teachers will. Every principal should know what the teacher experience feels like.')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button asChild variant="outline" size="sm" className="rounded-xl gap-1">
                            <Link href="/">
                                {t('Open teacher tools')}
                                <ArrowRight className="h-3.5 w-3.5" />
                            </Link>
                        </Button>
                    </CardContent>
                ...
                <Card className="rounded-2xl">
                    <CardHeader>
                        ...
                        <CardTitle className="text-base">{t('Preview a full dashboard')}</CardTitle>
                        <CardDescription className="text-xs">
                            {t('See what this page looks like once your school is active: weekly active teachers, content generated, time saved, feature adoption, at-risk alerts.')}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button asChild variant="outline" size="sm" className="rounded-xl gap-1">
