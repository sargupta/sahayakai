...
const intentPrompt = ai.definePrompt({
  ...
  prompt: `Analyze the user prompt to determine the intended tool and extract key parameters.
        ...
        - topic: The core subject matter as a CONCISE noun phrase (1-5 words), NOT a restatement of the user's sentence. Extract ONLY the academic concept. STRIP all conversational markers ("Hey", "Can you make", "help me", "please", "कसा है"), the artefact/tool name ("lesson plan", "quiz", "worksheet", "क्विज"), action verbs ("make", "create", "banao", "तैयार करो"), and metadata that belongs in other fields (strip "Class 5" → gradeLevel; strip "Maths" → subject). Examples: "can you help me make a lesson plan about photosynthesis for class 7" → topic: "Photosynthesis"; "Quiz on the French Revolution for grade 9" → topic: "French Revolution"; "Class 10 ka exam paper banao quadratic equations chapter ka" → topic: "Quadratic Equations". If the CURRENT prompt has no specific academic topic, return null — do NOT pull from chat history and do NOT echo back the whole utterance.
